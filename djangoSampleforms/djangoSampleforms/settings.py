"""
Django settings for djangoSampleforms project.
...
SECRET_KEY = 'zu^-9hiik520x&5)+-%8-cg@w0ygxw%iw6f(y$a2k6w49m#5tl'
...
ROOT_URLCONF = 'djangoSampleforms.urls'
...
WSGI_APPLICATION = 'djangoSampleforms.wsgi.application'
